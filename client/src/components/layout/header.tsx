      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3.5">
        <button className="flex items-center gap-3 text-left" onClick={() => navigate("/")} type="button">
          <span className="brand-mark size-11">
            ...
            <img src="../../../public/NARAD.png" alt="NARADMUNI"  className="size-12"/>
          </span>
          <span>
            <span className="block text-xl font-black leading-none tracking-tight">NARADMUNI</span>
        ...
        <nav className="hidden items-center gap-2 md:flex">
          ...
          <NavLink className={({ isActive }) => `top-nav-pill ${isActive ? "is-active" : ""}`} to="/createPolls">
            Create Polls
          </NavLink>
          {isAdmin ? (
          ...
          <button className="top-nav-pill" onClick={() => navigate("/createPolls")} type="button">
