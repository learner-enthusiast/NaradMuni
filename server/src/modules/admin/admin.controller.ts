...
import { pollsTable, responsesTable, usersTable } from '../../db/schema.js'
import { HttpError, requireAdminUser } from '../../lib/http.js'
import { getIO } from '../../lib/socket.js'
import { buildAnalytics, parseJson } from '../poll/poll.service.js'
...
export async function closePollAsAdmin(req: Request, res: Response) {
    ...
    const [updated] = await db
        ...
        .where(
            and(eq(pollsTable.id, pollId), ne(pollsTable.status, 'published'))
        )
        .returning()
